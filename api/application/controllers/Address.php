...
class Address extends CI_Controller{
    ...
    public $_table_column_array = ['uid','name','phone','country_code','address_en','address_ar','lat','lng','title','building','floor','apartment','landmark','city','country'];
    public $_table_column_edit = ['id','uid','name','phone','country_code','address_en','address_ar','lat','lng','title','building','floor','apartment','landmark','city','country'];
    public $required = ['id'];
