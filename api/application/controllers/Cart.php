...
class Cart extends CI_Controller{
    ...
    public $_table_column_array = ['uid','pid','pqty','price_type','price','datetime'];
    public $_table_column_edit = ['id','uid','pid','pqty','price_type','price','datetime'];
    public $required = ['id'];
    ...
    public function index(){
        ...
        // );
        // $this->Cart_model->saveUserLogs($saveLogInfo);
    ...
    public function getById(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->getById($_POST['id']);
                if($result != null){
    ...
    public function getByUid(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->getByUid($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
    ...
    public function getByUidDetailed(){
        $agent = $this->input->request_headers();
        // $saveLogInfo = array(
        //     'url' => $this->uri->uri_string(),
        //     'agent' => json_encode($agent),
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->getByUidDetailed($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
    ...
    public function editByUid(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->editByUid($_POST,$_POST['uid']);
    ...
    public function editList(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->editList($_POST,$_POST['id']);
    ...
    public function save(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->saveList($_POST);
                if($result != null){
                    $id = $this->db->insert_id();
                    $data = $this->Cart_model->getByIdValue($id);
                    echo $this->json->response($data,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response(['error'=>'Something Went Wrong.'],$this->_Errmessage,$this->_statusErr);
                }
    ...
    public function deleteList(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->deleteList($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response(['error'=>'Something Went Wrong.'],$this->_Errmessage,$this->_statusErr);
    ...
    public function deleteListByUid(){
        $agent = $this->input->request_headers();
        // $saveLogInfo = array(
        //     'url' => $this->uri->uri_string(),
        //     'agent' => json_encode($agent),
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Cart_model->deleteListByUid($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response(['error'=>'Something Went Wrong.'],$this->_Errmessage,$this->_statusErr);
