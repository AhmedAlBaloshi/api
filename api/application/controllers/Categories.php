...
class Categories extends CI_Controller{
    ...
    public $_table_column_array = ['name_en','name_ar','storeId','status'];
    public $_table_column_edit = ['id','name_en','name_ar','storeId','status'];
    public $required = ['id'];
    ...
    public function getAllCategoriesByAgent()
	{
        ...
        $auth  = $this->input->get_request_header('Basic');
        if($auth && $auth == $this->config->item('encryption_key')){
            $data = $this->Categories_model->getAllCategoriesByAgent();
            if($data != null){
                echo $this->json->response($data,$this->_OKmessage,$this->_statusOK);
            }else{
                echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
    ...
    public function getByStoreId(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Categories_model->getByStoreId($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
